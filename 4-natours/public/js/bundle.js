...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWlraXlvc2hpIiwiYSI6ImNsNDhvN3Y3aDB1YWoza213dXU4cHk2NTYifQ.AT-oYPsU-EI94ag2_QORnA'; // mapbox documentation from https://docs.mapbox.com/mapbox-gl-js/guides/
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Create Account in successfully!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error logging out!  Try it again.');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            //   ? type === 'review'
            //     ? `/api/v1/reviews/${req.params.slug}`
...
var deleteSettings = /*#__PURE__*/function () {
  ...
  return function deleteSettings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_51LAlwhKvVSOCj2Q7hwnOBhodG7KrBt5fkKQ6k868GZcqNifzp1tjL7hkUjv4LdDNuu8xgOdndax9V1RrlrO8tjpz00tSr5hdrX'); // get "Publishable key" from https://dashboard.stripe.com/test/apikeys // Developers > API key
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log('stripe.js', session); // 2) Create checkout form + charge credit card
...
var _deleteSettings = require("./deleteSettings");
...
var userDataForm = document.querySelector('.form-user-data'); // from account.pug form

var userPasswordForm = document.querySelector('.form-user-password'); // from account.pug form
// const reviewDataForm = document.querySelector('.form-review-data');

var reviewDelete = document.querySelector('.btn-review-delete');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordCurrent = document.getElementById('password-current').value; // same as Body from postman Authentication"Update Current User Password"

            password = document.getElementById('password').value; // same as Body from postman Authentication"Update Current User Password"

            passwordConfirm = document.getElementById('password-confirm').value; // same as Body from postman Authentication"Update Current User Password"
...
if (reviewDelete) reviewDelete.addEventListener('click', function (e) {
